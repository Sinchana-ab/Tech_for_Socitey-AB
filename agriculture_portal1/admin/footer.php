 <footer class="footer">
        <div class="container">
                ...
                <div class="offset-sm-2 col-5 ">
                    ...
                    <a role="button" class="btn btn-primary" href="tel:+917411101363"><i class="fa fa-phone"></i> Call</a>
                    <a role="button" class="btn btn-info" href="tel:+917411101363"> <i class="fa fa-fax"></i> Fax</a>
                    <a role="button" class="btn btn-success" href="sinchanaas8@gmail.com"> <i class="fa fa-envelope-o"></i> Email</a>
                </div>
		           </address>
                </div>
