...
<head>
  ...
  <link rel="icon" type="image/png" href="assets/img/logo.png" />
    <title>Farmer Assistence portal</title>
...
<div class="wrapper" >
    ...
    <div class="wrapper">
      <header class="jumbotron bg-gradient-success">
        <div class="container">
          <div class="row row-header">
            <div class="col-12 col-sm-6">
              <h1 class="text-white">Farmer Assistence  Portal</h1>
              <p class="text-white">
               A True Farmer's Friend for Crop and yield Prediction.
              </p>
              <div class="cg">
            ...
            <div class="col-12 col-sm-3 offset-sm-2 align-self-center">
              <img src="./assets/img/plant-bulb.png" class="img-fluid plant-bulb" alt="" />
...
const apiKey = "sk_test_51QQVVyF0P57CU7Pn9I1tRG5V5o4gal2zSVHWd4i5f5rWwogiqrSeKol58sw0pHD18197CcyqTcsevTrTFstRV9aA00V0Gt5Dxa";   // Enter your apikey here
